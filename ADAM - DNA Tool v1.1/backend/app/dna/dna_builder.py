...
from app.models.session import Session, PHASE_SECTION_MAP
...
QUESTION_INVENTORY = {
    ...
    "8": {
        "8.1.1": "Financial Governor Agent configuration",
        "8.1.2": "Legal & Compliance Governor Agent configuration",
        "8.1.3": "Security & Trust Governor Agent configuration",
        "8.1.4": "Market & Ecosystem Governor Agent configuration",
        "8.1.5": "Operations & Delivery Governor Agent configuration",
        "8.2.1": "Corporate Work Group domains",
        "8.2.2": "AI-Native Division domains",
    ...
    def export_dna_json(self) -> Dict[str, Any]:
        ...
        dna = {
            "meta": {
                ...
                "source": "ADAM DNA Tool v1.1",
                "generated": datetime.utcnow().isoformat(),
                "questionnaire_version": "1.1",
                # adam_version intentionally omitted — ADAM is a living doctrine; the book
                # version is the resolver's responsibility (Section 1.3 directive, 2026-04-20).
            },
            "sections": {},
        }
