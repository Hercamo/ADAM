...
Version: 1.1.0  (aligned with ADAM book v1.4 / BOSS v3.2, 81+ Agent Mesh,
...
BOSS_THRESHOLDS = {
    ...
    "MODERATE": (11, 30),     # Execute with additional logging and monitoring
    "ELEVATED": (31, 50),     # Human notified, can intervene
    "HIGH": (51, 75),         # Human approval required before execution
    "OHSHAT": (76, 100),      # Operational Hell, Send Humans Act Today — immediate halt
}
