...
cryptographically signed, properly authorized, and respect agent capability
boundaries as defined by the canonical 7-class mesh topology and the 5
canonical Governor Agents (Financial, Legal & Compliance, Security & Trust,
Market & Ecosystem, Operations & Delivery).

Author: ADAM Book v1.4
Version: 1.1.0
Python: 3.10+
"""
...
try:
    ...
    raise ImportError("cryptography >= 41.0.0 required for Ed25519 operations") from None
