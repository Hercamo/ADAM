...
Version 1.1 | April 2026 | ADAM AGT Light Plugin — aligned with ADAM book v1.4 (BOSS v3.2 canonical; 81+ Agent Mesh)
...
**Alternative Minimum**: If a 4-ring model is not used, document the privilege model and map to ADAM's authority levels (Meta-Governance, Governor Agent, Orchestration, Human Interface, Digital Twin, Corporate Work Group, AI-Centric Division).
