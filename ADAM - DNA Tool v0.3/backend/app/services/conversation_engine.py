...
from app.ai.providers import AIProvider, AIMessage, create_provider
from app.ai.adam_system_prompt import build_system_prompt, get_section_prompt
...
I'm your AI guide for implementing the **Autonomy Doctrine & Architecture Model** for your organization. Instead of filling out a static questionnaire, we'll work together conversationally — I'll analyze your existing documents and ask targeted questions to build your complete ADAM DNA configuration.
