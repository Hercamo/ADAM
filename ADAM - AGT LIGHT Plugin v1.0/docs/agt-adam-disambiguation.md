...
| **What it is** | A runtime communication protocol. Provides W3C DID-based cryptographic identity and IATP (Inter-Agent Trust Protocol) trust scoring (0-1000) for individual agents. | A 5-layer enterprise topology of 81 named agents across Meta-Governance, Governor, Orchestration, Human Interface, Digital Twin, and Work Group layers. Defines authority flows, domain boundaries, and agent relationships. |
...
| **Dimensions** | Single behavioral rating | 7 dimensions: Sovereignty Action (4.0), Security Impact (4.6), Financial Exposure (3.6), Regulatory Impact (3.5), Reputational Risk (3.3), Rights Certainty (3.2), Doctrinal Alignment (3.0) |
...
| **Who consumes it** | AGT feeds Regulatory Impact dimension inputs to ADAM's BOSS Engine | BOSS Engine computes Regulatory Impact dimension; Legal Director governs compliance decisions |
