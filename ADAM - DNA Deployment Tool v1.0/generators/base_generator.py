...
# ADAM's 81 agents organized by class
AGENT_CLASSES = {
    "super_agents": {
        "description": "Domain Governance - evaluate intent against domain constraints",
        "agents": [
            {"name": "Financial Governance Governor", "id": "sa-financial", "resources": {"vcpus": 50, "ram_gb": 200, "gpu": True}},
            {"name": "Legal & Compliance Governor", "id": "sa-legal", "resources": {"vcpus": 50, "ram_gb": 200, "gpu": True}},
            {"name": "Enterprise Risk Governor", "id": "sa-risk", "resources": {"vcpus": 50, "ram_gb": 200, "gpu": True}},
            {"name": "Market & Ecosystem Governor", "id": "sa-market", "resources": {"vcpus": 50, "ram_gb": 200, "gpu": True}},
            {"name": "Enterprise Strategy Governor", "id": "sa-strategy", "resources": {"vcpus": 50, "ram_gb": 200, "gpu": True}},
        ],
    },
    ...
    "corporate_work_groups": {
        ...
        "agents": [
            ...
            # Strategy & Objectives Work Group
            {"name": "Strategy Translation Agent", "id": "wg-strategy-translate", "resources": {"vcpus": 20, "ram_gb": 80, "gpu": True}},
            {"name": "KR Tracking Agent", "id": "wg-strategy-kr", "resources": {"vcpus": 20, "ram_gb": 80, "gpu": False}},
            {"name": "Innovation Portfolio Agent", "id": "wg-strategy-innovation", "resources": {"vcpus": 20, "ram_gb": 80, "gpu": True}},
...
class BaseGenerator:
    ...
    def header_comment(self, comment_char: str = "#") -> str:
        ...
        lines = [
            ...
            f"{comment_char} ADAM Version: 0.4 | DNA Questionnaire Version: 1.0",
            f"{comment_char} ============================================================",
