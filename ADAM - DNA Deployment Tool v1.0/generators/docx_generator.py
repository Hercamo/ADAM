...
class DocxSpecGenerator:
    ...
    def _generate_platform_doc(self, platform: str) -> str:
        ...
        doc.add_paragraph(
            f'ADAM Version: 0.4 | DNA Questionnaire Version: 1.0 | '
    ...
    def _add_boss_section(self, doc):
        ...
        doc.add_heading('5.1 BOSS Dimensions & Weights', level=2)
        doc.add_paragraph(
            'The BOSS (Business Operations Sovereignty Score) evaluates every proposed action '
            'across seven dimensions. Composite Score = Sum(Score_d x Weight_d) / Sum(Weight_d).'
        )
        ...
        thresholds = [
            ('0-10', 'SOAP', 'Full autonomous execution'),
            ('11-30', 'MODERATE', 'Autonomous with enhanced logging'),
            ('31-50', 'ELEVATED', 'Execution paused, governor review'),
            ('51-75', 'HIGH', 'Mandatory director review'),
            ('76-100', 'OHSHAT', 'Immediate CEO + all directors escalation'),
        ]
    ...
    def _add_governance_section(self, doc):
        ...
        doc.add_paragraph(
            ...
            '3) Super Agent governance evaluation, 4) BOSS scoring, '
    ...
    def _add_deployment_procedure(self, doc, platform):
        ...
        phases = [
            ...
            'Phase 4: Agent mesh deployment (81 agents across 6 classes)',
